 ...
 * - $is_admin: TRUE if the user has permission to menu-clicc administration pages.
 *
 * Site identity:
...
<div id="wrapper">
  <header id="header" role="banner">
    <?php if ($logo): ?><div id="logo"><a href="/clicc/welcome-clicc" title="<?php print t('Home'); ?>"><img src="<?php print $logo; ?>"/></a></div><?php endif; ?>
    ...
    <div class="clear"></div>
    <nav id="menu-clicc"  role="navigation">
      <a class="nav-toggle" href="#"><?php print t("Navigation"); ?></a>
      <div class="menu-navigation-container">
        <?php 
        if (module_exists('i18n_menu')) {
          $main_menu_tree = i18n_menu_translated_tree(variable_get('menu_main_links_source', 'menu-clicc'));
        } else {
          $main_menu_tree = menu_tree(variable_get('menu_main_links_source', 'menu-clicc'));
        }
